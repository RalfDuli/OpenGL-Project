...
public:
    ...
    Model(string const &path, glm::vec3 __pos, glm::vec3 __scl, bool gamma = false) : gammaCorrection(gamma)
    {
        loadModel(path);
        pos = __pos;
        scl = __scl;
...
private:
    ...
    Mesh processMesh(aiMesh *mesh, const aiScene *scene)
    {
        ...
        std::cout << "Material has:" << std::endl;
        ...
        std::cout << "Height textures: " << material->GetTextureCount(aiTextureType_AMBIENT) << std::endl;
    ...
    vector<Texture> loadMaterialTextures(aiMaterial *mat, aiTextureType type, string typeName)
    {
        ...
        for(unsigned int i = 0; i < mat->GetTextureCount(type); i++)
        {
            ...
            {
                cerr << "Would you stop: " << str.C_Str() << endl;
            ...
            {   // if texture hasn't been loaded already, load it
                ...
                cerr << "TEXTURE : " << texture.path << endl;
